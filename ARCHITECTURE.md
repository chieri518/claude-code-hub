...
| **ingest** | GitHub Action, manual then cron | `sources/sources.yaml`, upstream URLs, `hub/FORMAT.md`, `hub/**/*.md` | PR proposing changes to `sources/sources.yaml` and `hub/**/*.md` | Yes (headless `claude -p`) |
